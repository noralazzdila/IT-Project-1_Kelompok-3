...
class PengujiDosenController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('dosen.penguji.indexdosen', compact('pengujis'));
    }
    ...
    {
        return view('dosen.penguji.createdosen');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('dosen.penguji.indexdosen')
    ...
    {
        return view('dosen.penguji.showdosen', compact('penguji'));
    }
    ...
    {
        return view('dosen.penguji.editdosen', compact('penguji'));
    }
