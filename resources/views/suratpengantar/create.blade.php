...
<head>
    ...
    <title>Tambah Surat Pengantar - Koordinator PKL</title>
...
<div class="wrapper">
    ...
    <div class="col-10 d-flex flex-column">
        <div class="header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Tambah Surat Pengantar</h5>
            <div class="text-end">
        ...
        <div class="container mt-4 flex-grow-1">
            <div class="card shadow-sm p-4">
                ...
                <form action="{{ route('suratpengantar.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                    ...
                    <div class="mb-3">
                        <label for="file_surat" class="form-label">Upload File Surat (PDF, maks. 5MB) (Opsional)</label>
