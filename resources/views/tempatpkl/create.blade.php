...
<head>
    ...
    <title>Tambah Tempat PKL - Koordinator PKL</title>
...
<div class="wrapper">
    <div class="col-2 sidebar">
        ...
        <nav class="nav flex-column px-2">
            ...
            <a href="{{ route('tempatpkl.index') }}" class="nav-link active"><i class="fa fa-building me-2"></i> Kelola Tempat PKL</a>
    ...
    <div class="col-10 d-flex flex-column">
        <div class="header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Tambah Data Tempat PKL</h5>
            <div class="text-end">
