...
<head>
    ...
    <title>Kelola Data Tempat PKL</title>
...
<body>
   ...
   <div class="col-10 d-flex flex-column">
            <div class="header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Manajemen Tempat PKL</h5>
            ...
            <main class="container-fluid mt-4 flex-grow-1">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Kelola Tempat PKL</li>
                    </ol>
                </nav>
                ...
                <div class="card rounded-3 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                            <a href="{{ route('tempatpkl.create') }}" class="btn btn-primary">
                                <i class="fa-solid fa-plus me-2"></i> Tambah Tempat PKL
                            </a>
                            <form action="{{ route('tempatpkl.index') }}" method="GET" class="d-flex flex-wrap gap-2">
                                    ...
                                    @forelse ($tempatpkl as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('tempatpkl.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                                                    <a href="{{ route('tempatpkl.show', $item->id) }}" class="btn btn-sm btn-info text-white" title="Lihat"><i class="fa-solid fa-eye"></i></a>
                                                    <a href="{{ route('tempatpkl.edit', $item->id) }}" class="btn btn-sm btn-warning" title="Edit"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    @csrf
                                                    @method('DELETE')
