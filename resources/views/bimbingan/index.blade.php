...
<body>
    <div class="wrapper">
        <div class="col-2 sidebar">
            ...
            <a href="{{ route('bimbingan.index') }}" class="nav-link active"><i class="fa fa-chalkboard-teacher me-2"></i>Bimbingan</a>
                ...
                <div class="card rounded-3 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                            ...
                            <form action="{{ route('bimbingan.index') }}" method="GET" class="d-flex flex-wrap gap-2">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form onsubmit="return confirm('Apakah Anda Yakin ingin menghapus data ini?');" action="{{ route('bimbingan.destroy', $bimbingan->id) }}" method="POST">
                                                    <a href="{{ route('bimbingan.show', $bimbingan->id) }}" class="btn btn-sm btn-info text-white"><i class="fa-solid fa-eye"></i></a>
                                                    <a href="{{ route('bimbingan.edit', $bimbingan->id) }}" class="btn btn-sm btn-warning"><i class="fa-solid fa-pencil"></i></a>
                                                    @csrf
                                                    @method('DELETE')
