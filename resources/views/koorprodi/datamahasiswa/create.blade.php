...
@section('title', 'Tambah Data Mahasiswa - Koordinator Prodi')
...
<div class="container mt-4 flex-grow-1">
    <div class="card shadow-sm p-4">
        <h5 class="fw-bold mb-3">Formulir Data Mahasiswa Baru</h5>
        
        <form action="{{ route('koorprodi.datamahasiswa.store') }}" method="POST">
            @csrf
             <div class="mb-3">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="mt-2">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="jenis_kelamin" id="laki-laki" value="Laki-laki" {{ old('jenis_kelamin') == 'Laki-laki' ? 'checked' : '' }} required>
            ...
            <div class="d-flex justify-content-end mt-3">
                <a href="{{ route('koorprodi.datamahasiswa.index') }}" class="btn btn-secondary me-2"><i class="fa fa-times"></i> Batal</a>
