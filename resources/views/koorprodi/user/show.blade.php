...
@section('title', 'Detail User - Koordinator Prodi')
...
<div class="container mt-4 flex-grow-1">
    <div class="card shadow-sm p-4">
        ...
        <div class="d-flex justify-content-between mt-4">
            <a href="{{ route('koorprodi.user.index') }}" class="btn btn-secondary">
                <i class="fa fa-arrow-left"></i> Kembali
            </a>
            <a href="{{ route('koorprodi.user.edit', $user->id) }}" class="btn btn-primary">
