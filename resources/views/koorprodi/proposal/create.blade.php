...
@section('title', 'Tambah Proposal - Koordinator Prodi')

@section('header-title', 'Tambah Proposal')
...
<div class="container mt-4 flex-grow-1">
    <div class="card shadow-sm p-4">
        ...
        <form action="{{ route('koorprodi.proposal.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
