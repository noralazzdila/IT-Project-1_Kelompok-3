...
<head>
    ...
    <title>Kelola Surat Pengantar</title>
    ...
    <a href="{{ route('koorprodi.index') }}" class="nav-link {{ request()->routeIs('koorprodi.index') ? 'active' : '' }}"><i class="fa fa-home me-2"></i> Beranda</a>
        ...
        <div class="col-10 d-flex flex-column">
            <div class="header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Manajemen Surat Pengantar</h5>
                ...
                <div class="card rounded-3 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                            <!-- Add Surat Pengantar button or other controls can go here -->
                        </div>
                        @if(session('success'))
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center">
                                            <div class="alert alert-info mb-0">
                                                Data Surat Pengantar tidak ditemukan atau belum tersedia.
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
