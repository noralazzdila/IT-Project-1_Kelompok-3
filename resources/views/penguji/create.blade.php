...
<head>
    ...
    <title>Tambah Data Penguji - Koordinator PKL</title>
...
<div class="wrapper">
    ...
    <div class="col-10 d-flex flex-column">
        <div class="header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Tambah Data Penguji</h5>
            <div class="text-end">
            ...
            <div class="card shadow-sm p-4">
                ...
                <form action="{{ route('penguji.store') }}" method="POST">
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <a href="{{ route('penguji.index') }}" class="btn btn-secondary me-2"><i class="fa fa-times"></i> Batal</a>
