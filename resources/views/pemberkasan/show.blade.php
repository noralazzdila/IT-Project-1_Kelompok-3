...
<div class="wrapper">
    ...
    <div class="col-2 sidebar">
        ...
        <nav class="nav flex-column px-2">
            ...
            <a href="{{ route('tempatpkl.index') }}" class="nav-link"><i class="fa-solid fa-building me-2"></i> Tempat PKL</a>
            <a href="{{ route('datamahasiswa.index') }}" class="nav-link"><i class="fa-solid fa-id-card me-2"></i> Mahasiswa</a>
