...
<head>
    ...
    <title>Tambah Pemberkasan - Koordinator PKL</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    {{-- Menggunakan Font Awesome 6.5.0 seperti contoh Anda --}}
    ...
    <style>
        ...
        /* Menggunakan kelas 'active' pada Pemberkasan */
...
<div class="wrapper">
    <div class="col-2 sidebar">
        ...
        <nav class="nav flex-column px-2">
            ...
            <a href="{{ route('pemberkasan.index') }}" class="nav-link active"><i class="fa fa-folder me-2"></i> Kelola Pemberkasan</a>
        </nav>
    </div>

    <div class="col-10 d-flex flex-column">
        <div class="header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Tambah Data Pemberkasan</h5>
