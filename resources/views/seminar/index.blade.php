...
<head>
    ...
    <title>Manajemen Seminar PKL</title>
    ...
    <div class="wrapper">
        <div class="col-2 sidebar">
            <div class="text-center mb-4">
                {{-- Ganti asset() jika path gambar berbeda --}}
        ...
        <div class="col-10 d-flex flex-column">
            <div class="header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Manajemen Seminar PKL</h5>
            ...
            <div class="container-fluid mt-4 flex-grow-1 p-4">
