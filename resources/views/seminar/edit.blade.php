...
<head>
    ...
    <title>Edit Jadwal Seminar - Koordinator PKL</title>
...
<div class="wrapper">
    ...
    <div class="col-10 d-flex flex-column">
        <div class="header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Edit Jadwal Seminar</h5>
            <div class="text-end">
                ...
                <form action="{{ route('seminar.update', $seminar->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="nama_penguji" value="{{ old('nama_penguji', $seminar->nama_penguji) }}" placeholder="Ketik nama dosen penguji">
                        </div>
                    </div>
