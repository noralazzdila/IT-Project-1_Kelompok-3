...
<head>
    ...
    <title>Detail User - Koordinator PKL</title>
...
<div class="wrapper">
    ...
    <div class="col-2 sidebar">
        ...
        <nav class="nav flex-column px-2">
            ...
            <a href="{{ route('user.index') }}" class="nav-link active"><i class="fa fa-users me-2"></i> Kelola User</a>
            ...
            <a href="#" class="nav-link"><i class="fa fa-clipboard-list me-2"></i> Kelola Status</a>
