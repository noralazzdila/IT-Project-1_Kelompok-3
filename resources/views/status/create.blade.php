...
<head>
    ...
    <title>Tambah Status - Koordinator PKL</title>
    ...
    <div class="col-10 d-flex flex-column">
        ...
        <div class="container mt-4 flex-grow-1">
            <div class="card shadow-sm p-4">
                <h6 class="fw-bold mb-3">Form Tambah Status</h6>
                <form action="{{ route('status.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="nama_item" class="form-label">Nama Status</label>
                        <input type="text" class="form-control" id="nama_status" name="nama_status" placeholder="Masukkan nama status" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="tgl_update" name="tgl_update" required>
                    </div>
