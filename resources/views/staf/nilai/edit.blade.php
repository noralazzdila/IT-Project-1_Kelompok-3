...
@section('title', 'Edit Nilai - Staf')

@section('header-title', 'Edit Nilai Mahasiswa')
...
<div class="container mt-4 flex-grow-1">
    <div class="card shadow-sm p-4">
        ...
        <form action="{{ route('staf.nilai.update', $nilai->id) }}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="mt-3 d-flex justify-content-between">
              <a href="{{ route('staf.nilai.index') }}" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Kembali</a>
