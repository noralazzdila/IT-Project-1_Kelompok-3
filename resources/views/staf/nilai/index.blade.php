...
@section('title', 'Kelola Nilai - Staf')
...
<div class="container mt-4 flex-grow-1">
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <a href="{{ route('staf.nilai.create') }}" class="btn btn-primary">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $s->total_sks }}</td>
                        <td>
                            <a href="{{ route('staf.nilai.show', $s->id) }}" class="btn btn-sm btn-info" title="Lihat Detail">
                                <i class="fa fa-eye"></i>
                            </a>
                            <a href="{{ route('staf.nilai.edit', $s->id) }}" class="btn btn-sm btn-warning" title="Edit">
                                <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('staf.nilai.destroy', $s->id) }}" method="POST" class="d-inline"
