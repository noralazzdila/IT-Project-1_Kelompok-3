    ...
    <div class="col-2 sidebar">
        ...
        <nav class="nav flex-column px-2">
            <a href="{{ route('dosen.dashboard') }}" class="nav-link {{ request()->routeIs('dosen.dashboard') ? 'active' : '' }}"><i class="fa fa-home me-2"></i> Beranda</a>
                ...
                <a href="#" class="nav-link {{ request()->routeIs('dosen.seminar.*') ? 'active' : '' }}"><i class="fa fa-calendar me-2"></i> Kelola Seminar</a>
    ...
    <div class="col-10 d-flex flex-column">
        ...
        <div class="container mt-4 flex-grow-1">
            <div class="card shadow-sm p-4">
                ...
                <form action="{{ route('dosen.user.store') }}" method="POST">
    @csrf
    <div class="mb-3">
