...
@section('title', 'Kelola Nilai - Dosen')
...
@section('content')        
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <a href="{{ route('dosen.nilai.createdosen') }}" class="btn btn-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('dosen.nilai.destroydosen', $s->id) }}" method="POST" class="d-inline"
