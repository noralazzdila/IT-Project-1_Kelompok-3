...
@section('title', 'Tambah Data Proposal')

@section('header-title', 'Tambah Data Proposal')

@section('content')
<div class="card shadow-sm p-4">
    <h5 class="fw-bold mb-3">Formulir Proposal Baru</h5>
    
    <form action="{{ route('dosen.proposal.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
