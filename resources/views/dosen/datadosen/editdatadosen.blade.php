    ...
    <div class="col-10 d-flex flex-column">
        ...
        <div class="container mt-4 flex-grow-1">
            <div class="card shadow-sm p-4">
                ...
                <form action="{{ route('dosen.datadosen.updatedatadosen', $datadosen) }}" method="POST">
                    @csrf
                    @method('PUT')
                     <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <a href="{{ route('dosen.datadosen.indexdatadosen') }}" class="btn btn-secondary me-2"><i class="fa fa-times"></i> Batal</a>
