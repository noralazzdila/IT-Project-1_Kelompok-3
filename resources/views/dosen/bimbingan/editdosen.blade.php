...
<head>
    ...
    <title>Edit Data Bimbingan - Koordinator PKL</title>
...
<div class="wrapper">
    ...
    <div class="col-10 d-flex flex-column">
        <div class="header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Edit Data Bimbingan</h5>
            <div class="text-end">
        ...
        <div class="container mt-4 flex-grow-1">
            <div class="card shadow-sm p-4">
                ...
                <form action="{{ route('dosen.bimbingan.updatedosen', $bimbingan->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        <a href="{{ route('dosen.bimbingan.indexdosen') }}" class="btn btn-secondary me-2"><i class="fa fa-times"></i> Batal</a>
